...
var posters: [Poster] = [
      ...
      Poster(title: "Polar Bear's Special Force", image: "Poster-3", subTitle: "A special force team of polar bears", price: "$29.99"),
      Poster(title: "Playboy Lion", image: "Poster-4", subTitle: "A playboy lion", price: "$29.99"),
      Poster(title: "Bee and Ant Army Invasion", image: "Poster-5", subTitle: "An invasion from the army of bee and ant", price: "$29.99")
]
